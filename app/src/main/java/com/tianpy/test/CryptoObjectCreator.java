...
public class CryptoObjectCreator {
    private static final String KEY_NAME = "com.n22.mobile.crypto_object_fingerprint_key";
            ...
            public void run() {
                try {
                    if (mCryptoObject != null) {
                        ...
                        // of the fingerprint.
                        if (!initCipher()) {
                            Log.d("crypto","Failed to init Cipher.");
                        }
                    }
                } catch (Exception e) {
                    Log.d("crypto"," Failed to init Cipher, e:" + Log.getStackTraceString(e));
                }
...
private void createKey() {
    ...
    try {
        ...
        Log.d("crypto"," Failed to createKey, e:" + Log.getStackTraceString(e));
...
private boolean initCipher() {
    try {
        ...
        Log.d("crypto"," Failed to initCipher, e:" + Log.getStackTraceString(e));
        return false;
